...
export default function Home() {
  ...
  const allReviews: {initial: string, name: string, date: string, text: string}[] = [
    { initial: '부', name: '부산동래구맛집탐방95', date: '2026.09.07', text: '' },
    ...
    { initial: '부', name: '부산동래구맛집탐방8', date: '2026.07.27', text: '' },
    { initial: '부', name: '부산동래구단골손님49', date: '2026.07.20', text: '' },
    { initial: '부', name: '부산동래구현지주민93', date: '2026.07.13', text: '' },
    ...
    { initial: '부', name: '부산동래구단골손님75', date: '2026.06.08', text: '부산 동래구 가족 외식으로 뭉태기에 갔는데 생갈비살이 정말 부드럽고 맛있어서 온 가족이 만족했어요. 서비스도 친절하고 분위기도 좋아서 부산 동래구 맛집으로 강력 추천합니다.' },
    { initial: '부', name: '부산동래구맛집탐방62', date: '2026.06.01', text: '부산 동래구 친구 모임으로 뭉태기에 갔는데 생갈비살이 정말 부드럽고 맛있어서 모두 만족했어요. 분위기도 좋고 음식도 훌륭해서 부산 동래구 맛집으로 강력 추천합니다.' },
    ...
    { initial: '부', name: '부산동래구현지주민25', date: '2026.04.27', text: '부산 동래구 가족 외식으로 뭉태기에서 생갈비살을 먹었는데 고기가 정말 부드럽고 맛있었습니다. 동래구 맛집으로 꼭 추천하고 싶은 곳이네요.' },
    { initial: '부', name: '부산동래구단골손님86', date: '2026.04.20', text: '부산 동래구 데이트 코스로 뭉태기에 갔는데 생갈비살이 정말 부드럽고 맛있어서 감동했어요. 분위기도 좋고 음식 퀄리티가 뛰어나서 부산 동래구 맛집으로 강력 추천합니다.' },
    { initial: '부', name: '부산동래구현지주민25', date: '2026.04.13', text: '부산 동래구 친구 모임으로 뭉태기에 갔는데 생갈비살이 정말 부드럽고 맛있더라고요. 확실히 부산 동래구 맛집답게 다음에도 꼭 재방문하고 싶어서 지인들에게 추천하고 있어요.' },
    { initial: '부', name: '부산동래구단골손님15', date: '2026.04.06', text: '부산 동래구 회식으로 뭉태기를 방문했는데 생갈비살이 정말 부드럽고 맛있어서 깜짝 놀랐습니다. 분위기도 좋고 음식 퀄리티도 훌륭해서 부산 동래구 맛집으로 강력 추천하고 싶어요.' },
    { initial: '부', name: '부산동래구방문객88', date: '2026.04.06', text: '동래구 명륜동에 있는 이 고깃집은 한우 등심이 정말 부드럽고 육즙이 살아있어서 감탄했어요. 밑반찬도 정갈하고 직원분들이 친절해서 가족 모임 장소로 강력 추천합니다.' },
    ...
    { initial: '부', name: '부산동래구방문객58', date: '2026.04.06', text: '동래구 온천천로에 있는 한우마을에서 등심과 갈비살을 먹었는데 고기 질이 정말 좋고 직원분들도 친절했어요. 가격은 조금 비싸지만 그만큼 맛과 서비스가 만족스러워서 가족 모임 때 다시' },
    { initial: '부', name: '부산동래구방문객29', date: '2026.04.06', text: '동래 명지식당에서 한우 갈비살을 먹었는데 육질이 부드럽고 고소한 맛이 일품이었어요. 사장님이 직접 구워주셔서 더욱 맛있게 먹을 수 있었고 재방문 의사 100%입니다.' },
    { initial: '부', name: '부산동래구단골손님62', date: '2026.04.06', text: '동래구에 위치한 이 고깃집은 한우 등심이 정말 부드럽고 육즙이 풍부해서 감탄했어요. 밑반찬도 깔끔하고 사장님이 친절해서 가족들과 함께 다시 방문하고 싶습니다.' },
    { initial: '부', name: '부산동래구미식가75', date: '2026.04.06', text: '온천천 근처에 있는 이 고깃집은 한우 품질이 정말 좋아서 입에서 살살 녹더라구요. 사장님도 친절하시고 밑반찬도 깔끔해서 가족들과 다시 방문할 예정입니다.' },
    { initial: '부', name: '부산동래구미식가45', date: '2026.04.06', text: '동래 벌통삼겹살에서 두툼한 삼겹살을 먹었는데 육즙이 풍부하고 불맛이 일품이었어요. 밑반찬도 정갈하게 나오고 직원분들이 친절해서 가족 모임 장소로 강추합니다.' },
    { initial: '부', name: '부산동래구미식가98', date: '2026.04.06', text: '동래 온천장 근처에 있는 이 한우집은 고기 질이 정말 좋고 직원분들도 친절하게 구워주셔서 편하게 먹을 수 있었어요. 가격은 조금 비싸지만 그만큼 고기가 부드럽고 맛있어서 특별한 날' },
    { initial: '부', name: '부산동래구현지주민53', date: '2026.04.06', text: '동래구에 있는 이 고깃집은 한우 갈비살이 정말 부드럽고 육즙이 풍부해서 감동받았어요. 밑반찬도 깔끔하고 사장님이 친절해서 가족들과 함께 다시 방문하고 싶습니다.' },
    { initial: '부', name: '부산동래구미식가65', date: '2026.04.06', text: '동래구 온천장역 근처에 있는 한우전문점에서 등심을 먹었는데 육질이 정말 부드럽고 고소했어요. 직원분들도 친절하시고 밑반찬도 깔끔해서 가족모임 장소로 추천하고 싶습니다.' },
